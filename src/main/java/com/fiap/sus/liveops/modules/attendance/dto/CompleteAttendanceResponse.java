...
public record CompleteAttendanceResponse(
        ...
        @Schema(description = "Status atual do atendimento", example = "DISCHARGED")
        ...
        @Schema(description = "Data e hora de início do atendimento efetivo (quando o paciente é chamado para atendimento)", example = "2026-02-12T20:15:00.000")
        LocalDateTime startTime,

        @Schema(description = "Data e hora de alta do paciente (quando o atendimento é finalizado)", example = "2026-02-12T21:00:00.000")
